 ...
 *
 * <p>The source code for this class was taken from:
 * <a href="http://onjava.com/pub/a/onjava/excerpt/jebp_3/index1.html?page=3">
 * This tutorial on Servlet Best Practices</a></p>
 */
public class ResourceLoader implements Serializable {
    ...
    public ResourceLoader(String name) throws IOException {
        this.name = name;
